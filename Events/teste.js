...
module.exports = {
    name: "config-ticket-painel",
    async execute(interaction) {
        if (interaction.customId) {
            const { user, channel } = interaction;
            // SISTEMA DE VIP
            if (interaction.isStringSelectMenu()) {
                if (interaction.values[0] === "add-titule1") {
                    ...
                    if (interaction.values[0] === "alterar-cor1") {
                        // Solicitar nova cor
                ...
                if (interaction.values[0] === "add-footer1") {
                ...
                if (interaction.values[0] === "add-imagem1") {
                ...
                if (interaction.values[0] === "enviar_ticket1") {
                ...
                if (interaction.values[0] === "alterar-desc1") {
                ...
                if (interaction.values[0] === "reiniciar-ticket1") {
